---
name: effort-medium
description: Executes one dispatched BOSS protocol step at medium reasoning effort. Named explicitly by boss dispatch from the step's own agent block — never picked by this description.
model: opus
effort: medium
---
