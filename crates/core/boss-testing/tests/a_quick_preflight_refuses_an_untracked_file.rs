...
impl Tree {
    fn new(tag: &str) -> Tree {
        ...
        // gate.sh refuses to run without the helpers it sources — the
        // lint vocabulary (a lint's exit 3 is a refusal, backlog
        // a26f92c4) and the target-dir rule (backlog 955c99b6) — and
        // which those are is gate.sh's own to say.
