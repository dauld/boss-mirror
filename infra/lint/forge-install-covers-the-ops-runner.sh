...
for u in reap-dead-ci-jobs cluster-deploy-runner disk-floor-sweep forge-converge estate-observe-host cluster-watchdog forge-backup estate-observe-units boss-ops-runner; do
